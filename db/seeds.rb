...
Author.create!([
  ...
  {name: "J. Glenn Brookshear", description: "J. Glenn Brookshear(グレン・ブル
    ...
    {name: "Sebastian Raschka", description: "Sebastian Raschka著者ページについて
      ...
      {name: "左門 至峰", description: ""},
      {name: "平田 賀一", description: ""},
      {name: "山内 大史", description: ""},
      {name: "幸田 廣信", description: ""},
      {name: "Jonathan Rasmusson", description: ""},
      {name: "株式会社リクルートテクノロジーズ", description: ""},
      {name: "TAC情報処理講座", description: ""},
...
顧客折衝から実務まで横断的に担当する。
女性新人エンジニアの教育に奮闘中！"},
      {name: "寺尾 英作", description: ""},
      {name: "中村 知成", description: ""},
      {name: "横田 真俊", description: ""},
      {name: "JPCERT/CC", description: ""},
      {name: "Chad Fowler", description: ""},
      {name: "林 良二", description: ""},
      {name: "末永 貴一", description: ""},
...
の更新ができます。著者セントラルに申し込んで、あなたの著者ページに、著者写真、著者紹介文を掲載しませんか？ご登録、ご利用は無料です。"},
      {name: "大津繁樹", description: ""},
      {name: "Jxck", description: ""},
      {name: "小林秀和", description: ""},
      {name: "佐々木庸平", description: ""},
      {name: "篠崎祐輔", description: ""},
...
・サイン会などのイベント情報
の更新ができます。著者セントラルに申し込んで、あなたの著者ページに、著者写真、著者紹介文を掲載しませんか？ご登録、ご利用は無料です。"},
      {name: "牧 隆史", description: ""},
      {name: "日経ソフトウエア", description: ""},
      {name: "原田 騎郎", description: ""},
...
Twitter: @ryuzee
http://www.ryuzee.com/"},
      {name: "松浦 隼人", description: ""},
      {name: "須藤 涼介", description: ""},
      {name: "生沼 一公", description: ""},
      {name: "森下 雅章", description: ""},
      {name: "日経リナックス", description: ""},
      {name: "Sam Newman", description: ""},
      {name: "Sam Newman", description: ""},
      {name: "Eben Hewitt", description: ""},
      {name: "ビープラウド", description: ""},
      {name: "Dave Thomas", description: ""},
      {name: "杉山 貴章", description: ""},
...
・サイン会などのイベント情報
の更新ができます。著者セントラルに申し込んで、あなたの著者ページに、著者写真、著者紹介文を掲載しませんか？ご登録、ご利用は無料です。"},
      {name: " Yugui（Yuki Sonoda)", description: ""},
      {name: "中津川 篤司", description: ""},
      {name: "前佛 雅人", description: ""},
      {name: "松原 豊", description: ""},
...
『Javaルールブック』(技術評論社) 
等。"},
      {name: "松本 勇気", description: ""},
      {name: "吉田 真吾", description: ""},
      {name: "今井 智明", description: ""},
...
大学在学中より黎明期のインターネットプロバイダの立ち上げや業務システムやゲームソフトウェアの開発を経験。大学卒業後はソニーコンピュータエンタテインメントに入社し、2001年頃に当時としてはまだ珍しい家庭用ゲーム機のオンライン通信ゲーム開発・運用に携わる。その後本格的なオンラインゲームの普及に伴い、大規模オンラインゲームシステムの構築・運用を経験。2010年、米国アマゾンドットコム社のクラウドサービス「アマゾンウェブサービス」の日本国内初のエンジニアとして採用され、様々な企業のクラウドサービス導入を技術支援。2015年、株式会社ソラコムの立ち上げに参画。 岐阜出身。早稲田大学理工学部電気電子情報工学科卒。"},
      {name: "冨永 善視", description: ""},
      {name: "藤原 吉規", description: ""},
      {name: "大栗 宗", description: ""},
      {name: "松原豊", description: ""},
      {name: "片山 暁雄", description: ""},
      {name: "松下 享平", description: ""},
      {name: "大槻 健", description: ""},
      {name: "鈴木 貴典", description: ""},
      {name: "竹之下 航洋", description: ""},
      {name: "日経Linux", description: ""},
...
Seleniumに関する情報共有や質問の場である「日本Seleniumユーザーコミュニティ」の運営も行っている。"},
      {name: "戸田 広", description: ""},
      {name: "沖田 邦夫", description: ""},
      {name: "宮田 淳平", description: ""},
      {name: "長谷川 淳", description: ""},
      {name: "清水 直樹", description: ""},
      {name: "Vishal Banthia", description: ""},
      {name: "Mark Fewster", description: ""},
      {name: "Dorothy Graham", description: ""},
      {name: "Adrian Mouat", description: ""},
      {name: "水頭 一壽", description: ""},
      {name: "米澤 遼", description: ""},
      {name: "藤田 裕士", description: ""},
...
著書に『ゼロから作るDeep Learning』、翻訳書に『コンピュータシステムの理論と実装』、『実践機械学習システム』、『実践 Python 3』（以上、オライリー・ジャパン）などがある。"},
      {name: "Mark Summerfield", description: ""},
      {name: "銭 飛", description: ""},
      {name: "Ilya Grigorik", description: ""},
...
2016年8月　　　　　　　　インターステラテクノロジ㈱入社．低価格民生ロケットの研究開発に従事"},
      {name: "Nicholas C. Zakas", description: ""},
      {name: "Stoyan Stefanov", description: ""},
      {name: "Michael S. Mikowski", description: ""},
      {name: "Josh C. Powel", description: ""},
      {name: "WINGSプロジェクト阿佐志保", description: ""},
      {name: "山田祥寛", description: ""},
      {name: "中井 悦司", description: "1971年大阪生まれ。予備校講師から転身、外資系ベンダーでLinux/OSSを中心とするプロジェクトをリードするかたわら、多数のテクニカルガイド、雑誌記事などを執筆。その後、Linuxディストリビューターのエバンジェリストを経て、現在は、米系IT企業のCloud Solutions Architectとして活動。"},
      ])
...
平成27年度の「午後1」「午後2」のみを徹底的に分析し、深く解説。問題文にじっくり向き合えば、正答の導き方がわかります!ネットワークの「基礎」とは何かをつかむ―マンガ「ネット犯罪の犯人を追え」を掲載。"},
    ...
    isbn: "4774172944",
    publisher_id: 3, language_id: 2, pages: 352,
...
平成26年度の「午後1」「午後2」のみを徹底的に分析し、深く解説。問題文にじっくり向き合えば、正答の導き方がわかります!ネスペを志す方への「道」の指針を示したストーリーも掲載。"},
    ...
    isbn: "4774163899",
    publisher_id: 3, language_id: 2, pages: 328,
    dimension: "21 x 14.8 x 2.2 cm", public_date: "2014/3/27",
    description: "内容紹介
Amazonのネットワークスペシャリスト部門でダントツ人気を誇る過去問解説書「ネスペ」シリーズの最新版が装いを新たに登場! 【25年度試験の「午後I・午後II」に的を絞って解説/問題文を深く掘り下げ、答えを導き出す思考プロセスを詳しく解説/本質の理解を問う確認問題により、理解度のチェックができる/正答以外がなぜ間違っているかということにも言及/解答の組み立て方がわかる】といった特徴が受験者に支持されています。「合格のポイント」解説も、正答を導き出すための実践的なアドバイスが満載。「真の実力」が身に付きます!

内容（「BOOK」データベースより）
ネットワークスペシャリスト試験平成25年度の「午後1」「午後2」のみを徹底的に分析し、深く解説。"},
    {title: "アジャイルサムライ−達人開発者への道",
    isbn: "4274068560",
    publisher_id: 10, language_id: 2, pages: 288,
...
（「監訳者あとがき」より）"},
    ...
    isbn: "4798143669",
    publisher_id: 2, language_id: 2, pages: 200,
...
「TAC出版ストア」はこちらから→http://www.amazon.co.jp/b?node=2827320051"},
    ...
    isbn: "4802610432",
    publisher_id: 12, language_id: 2, pages: 2,96
...
日本大学工学部電気工学科を卒業後、民放ラジオ局の子会社で番組制作に携わる放送音声ミキサーを担当。その後、電機会社で音響機器の回路設計、デジタルオーディオ応用機器の商品開発を担当。音声圧縮応用の開発会社の立ち上げに参画の後、独立してのソフト開発を行なう。その後、ソフト開発会社に入社、DSCプリント店頭受付機アプリケーションの開発やデジタルイメージング応用アプリケーション、プリントラボ用システムの開発を担当。現在、屋号「プロノワ」にて、画像処理、音声処理を中心に開発業務に携わる(本データはこの書籍が刊行された当時に掲載されていたものです)"},
    ...
    isbn: "4797377224",
    publisher_id: 14, language_id: 2, pages: 576,
...
試験合格に必要な知識を完全網羅。詳解テキスト+模擬問題345問。練習問題+模擬試験2回分。最短ルートで合格必達!!『超』初心者でも合格必達!前提知識から解説充実。試験直前向けの要点まとめチェックリスト付き。"},
    ...
    isbn: "4798148865",
    publisher_id: 2, language_id: 2, pages: 592,
...
ライブラリを使ってモダンな外観を作る手順も詳しく解説しています。"},
    ...
    isbn: "4774182427",
    publisher_id: 3, language_id: 2, pages: 168,
...
自作派のためのコンピューター技術情報誌"},
    ...
    isbn: "4873117607",
    publisher_id: 1, language_id: 2, pages: 344,
...
柔軟かつシンプルな新時代のソフトウェアアーキテクチャ、マイクロサービスの本質に迫る!モノリシック(一枚岩)からの脱却。複数の小さいマイクロサービスに分割してそれらを連携させることで、迅速なデプロイ、優れた回復性やスケーラビリティを実現する。"},
    ...
    isbn: "1491933666",
    publisher_id: 16, language_id: 1, pages: 342,
...
Eben Hewitt is Director of Application Architecture at a publicly traded company where he is responsible for the design of their mission-critical, global-scale web, mobile and SOA integration projects. He has written several programming books, including Java SOA Cookbook (O'Reilly)."},
    {title: "Cassandra: The Definitive Guide (英語)",
    isbn: "",
    publisher_id: 16, language_id: 1, pages: 301,
...
Eben Hewitt is Director of Application Architecture at a publicly traded company where he is responsible for the design of their mission-critical, global-scale web, mobile and SOA integration projects. He has written several programming books, including Java SOA Cookbook (O'Reilly)."},
    ...
    isbn: "479804315X",
    publisher_id: 15, language_id: 2, pages: 472,
...
またIT業界の活発化、横のつながり促進のため、コミュニティ活動にも会社として積極的に取り組み、会社主催のWeb系IT勉強会「BPStudy」は2007年9月から毎月開催し、2015年2月で、90回目の開催を迎える。"},
    {title: "プログラミングElixir",
    isbn: "4274219151",
    publisher_id: 10, language_id: 2, pages: 360,
...
言語の基本から、並行プログラミング、OTP、マクロまで、Elixirの魅力を丁寧に解説。"},
    ...
    isbn: "4774174416",
    publisher_id: 3, language_id: 2, pages: 112,
...
IoTシステムの全体像をつかむ。各セグメントの位置づけと関連性がわかる!"},
    ...
    isbn: "",
    publisher_id: 3, language_id: 2, pages: 92,
...
5章 Extension～Hackの拡張"},
    ...
    isbn: "4822237869",
    publisher_id: 4, language_id: 2, pages: 145,
...
コンピュータ・サイエンス&テクノロジー専門誌"},
    ...
    isbn: "4774178942",
    publisher_id: 3, language_id: 2, pages: 416,
...
テストの手間とミスを減らし、開発効率を上げる。導入から大規模事例までを網羅。"},
    ...
    isbn: "",
    publisher_id: 2, language_id: 2, pages: 797,
...
退屈なテストにさようなら。システムテストを自動化するプログラムを技術・組織の両面から実践的に解説。Seleniumなどの各種ツールを使ったシステムテスト自動化の事例も収録。"},
    {title: "Docker",
    isbn: "4873117763",
    publisher_id: 1, language_id: 2, pages: 384,
...
仕事や研究で役立つ実践的な側面を重視し、一般的なプログラミングのベストプラクティスをPythonに適用する方法について解説します。主なテーマは、エレガントなコーディングのためのデザインパターン、処理速度向上のための並行処理とCython、高レベルなネットワーク処理、そしてグラフィックスです。読者対象は中級以上のPythonプログラマー。実践的なベストプラクティスを示し、巷で囁かれてきた「デザインパターンはPythonには不向き」「Pythonはマルチコアの恩恵を受けられない」といった認識が間違いであり、迷信にすぎなかったことを明らかにします。2014年米国Joltアワード受賞書、待望の邦訳。"},
    {title: "ROSプログラミング ",
    isbn: "4627853416",
    publisher_id: 18, language_id: 2, pages: 306,
...
・Part3 音声でロボットを制御"},
    ...
    isbn: "4873116767",
    publisher_id: 1, language_id: 2, pages: 480,
...
本書は「ブラウザ」に関連する、インターネットで使用される様々なネットワーク技術をまとめたものです。WebSocketやHTTP/2.0やWebRTCのように最新ブラウザで簡単に動作する新しい技術から、そのような技術の土台となるTCPやUDPやトランスポート層についてまで幅広くカバーします。"},
    ...
    isbn: "478983395X",
    publisher_id: 17, language_id: 2, pages: 191,
...
ソフトウェア開発のセンスでHDLを使うと、所望の性能を得られない回路、あるいはまったく動作しない回路を作ってしまうことがある。ソフトウェア的に考えた処理を回路化する手順を示し、さらに回路を最適化する方法を解説。"},
    ...
    isbn: "4873116813",
    publisher_id: 1, language_id: 2, pages: 200,
...
JavaScriptが持つオブジェクト指向的な言語特性や、その特性を強力にサポートするECMAScript 5の機能を紹介し、それらの特性や機能を活かすプログラミングの方法や考え方、パターンについて深く、そして簡潔に解説。"},
    ...
    isbn: "4873114888",
    publisher_id: 1, language_id: 2, pages: 244,
...
JavaScriptについては一通りマスターした中上級者がさらに上を目指すための高度でかつ有用なテクニックを盛り込んでいます。デザインパターン、コーディングパターン、アンチパターンに基づき、いままで以上にJavaScriptを使いこなし、プログラミングの力を向上させ、JavaScriptのエキスパートになるための知識と技を豊富に紹介。次のステップに踏み出したいプログラマにとって貴重な情報源となる一冊です。Yahoo!のエンジニアとして数々の有用なアプリケーションの開発に携わってきた著者がJavaScriptを200%使いこなすための秘伝を伝授します。"},
    ...
    isbn: "4873116732",
    publisher_id: 1, language_id: 2, pages: 498,
...
Linuxのコンテナ仮想化ツールであるDockerを使って、コードでインフラ環境を構築するための入門書です。開発環境や実行環境などインフラ構築「自動化」の経験がない開発者を対象に、おさえておきたいシステム基盤&インフラの基礎知識に加えて、Dockerによるインフラ構築と管理の方法をやさしく解説します。理解しにくいネットワークや仮想技術などのインフラの基礎概念を図解しながら、開発/実行環境を実際に構築することで、構成管理ツールを使ったインフラ構築の流れを解説していきます。"},
    ...
    isbn: "4774184268",
    publisher_id: 3, language_id: 2, pages: 272,
